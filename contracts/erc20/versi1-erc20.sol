...
//change the name kakanda and the symbol to whatever you would like

contract kakanda is ERC20 {
    string public constant symbol = "KDRT";
    string public constant name = "Mas Kakanda";
    uint8 public constant decimals = 18;
 
    //Tokenn 1,000,000+18 zeros
